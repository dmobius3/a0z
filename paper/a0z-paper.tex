...
\citep{Lelli2016} and Planck background value \citep{Planck2018},
...
fixed baryonic mass. The existing \citet{Ubler2017} KMOS3D measurement
...
\citet{Labbe2023} massive candidates. Whether this resolves the
...
The KMOS3D analysis of \citet{Ubler2017} is the only existing
...
relative to the local \citet{Lelli2016} baseline are
\begin{equation*}
...
strictly monotonic decrease (dashed); the \citet{Ubler2017} data are
...
$z = 0$ (Section~\ref{sec:derivation}). The \citet{Genzel2017}
...
consistent with \citet{Moster2013} stellar-to-halo mass relation and
\citet{Duffy2008} concentration evolution:
...
Parameterization & $(\Mhalo, c)$ at $z = 0$ & $(\Mhalo, c)$ at $z = 2$
                & $\Mdyn/\Mb$: $z=0$ / $z=2$ & Framework / $\Lambda$CDM at $z=2$ \\
\midrule
