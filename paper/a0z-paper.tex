...
% Target journal: Foundations of Physics (Springer)
%
% Build:
%   pdflatex a0z-paper
%   pdflatex a0z-paper
...
%
% Class: Springer svjour3 in single-column "smallextended" layout.
% svjour3.cls + svglov3.clo + sp{basic,phys,mpsci}.bst are bundled in
% this directory (sourced from https://github.com/latextemplates/svjour,
% upstream copyright Springer; only valid for Springer-journal
% submissions).
% =====================================================================

\documentclass[smallextended]{svjour3}
% \documentclass[11pt,a4paper]{article}   % review/draft fallback
\journalname{Found.\ Phys.}

% --- core packages ---------------------------------------------------
% svjour3 already sets page geometry and loads basic font/encoding
% support; only the analysis-content packages are added here.
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage{lmodern}
\usepackage{microtype}
\usepackage{amsmath,amssymb}
% NOTE: svjour3 provides its own theorem/proof environments; do NOT load
% amsthm or its \proof macro will collide with svjour3's.
...
\titlerunning{Epoch-Dependent Acceleration Scale}

\author{B. Shatto}

\authorrunning{B. Shatto}
